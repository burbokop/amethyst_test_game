...
use amethyst::{
    input::is_key_down, prelude::*, utils::application_root_dir,
...
fn main() -> amethyst::Result<()> {
    {
        ...
        if !(version.major == 1 && version.minor == 47 && version.patch == 0) {
            panic!("app must be compiled by rustc version 1.47.0 (do in terminal 'rustup default 1.47.0')")
        }
    }
